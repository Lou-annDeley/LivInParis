...
namespace TestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void TestFloydWarshall()
        {
            ...
            Noeud<string> noeud2 = metro.AjouterSommet(station2);
            metro.AjouterLien(noeud, noeud2, 2);
            List<Noeud<string>> plus_petit_cheminS2 = metro.FloydWarshall(noeud, noeud2);
            string chemin = "";
            foreach (Noeud<string> c in plus_petit_cheminS2)
            {
                chemin += c.Valeur + " ";
        ...
        [TestMethod]
        public void TestFloydWarshall_pluslong()
        {
            Graphe<string> metro = new Graphe<string>();
            ...
            List<Noeud<string>> plus_petit_chemin = metro.FloydWarshall(A, E);
        ...
        [TestMethod]
        public void TestFloydWarshall_memedepartarrivee()
        {
            Graphe<string> metro = new Graphe<string>();

            Noeud<string> A = metro.AjouterSommet("Chatelet");

            List<Noeud<string>> plus_petit_chemin = metro.FloydWarshall(A, A);
